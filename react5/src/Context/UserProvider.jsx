...
export function UserProvider({ children }) {
  ...
  useEffect(() => {
    axios("http://localhost:8000/drons").then((res)=>setData(res.data))
  }, [])
...
//---------------------------------PROVIDER-----------------------------------------------------------------------
    ...
    return (
      <getDron.Provider value={{ data, cart, setCart, cartQuantity, setCartQuantity, buyProducts, restProducts, deleteProduct, deleteHeart, setHeart, heart, setHeartQuantity, heartQuantity, AddFavorites,handleFavoriteClick,setIsHeartColored,setCardStates,cardStates,username, setUsername}}>{children}</getDron.Provider> 
